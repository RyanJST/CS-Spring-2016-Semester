...
namespace PS6_personal_Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void Test30a()
        {
            ...
            s.SetContentsOfCell("A1", "Hello");
            s.SetContentsOfCell("A1", "=23");
            Assert.AreEqual(23, ((double)s.GetCellValue("A1")));
        }
        // STRESS TESTS
        [TestMethod()]
        public void Test31()
        ...
        public void Test31a()
        {
            ...
            {
                Assert.AreEqual(0, (double)s.GetCellValue(cell), 1e-9);
            }
        }
        ...
        public void Test31d()
        {
            ...
            s.SetContentsOfCell("D7", "=E1");
            s.SetContentsOfCell("D8", "=E1");
            ISet<String> cells = s.SetContentsOfCell("E1", "5");

            Assert.AreEqual(625.0, s.GetCellValue("A1"));
            Assert.AreEqual(0.0, s.GetCellValue("B1"));
            Assert.AreEqual(625.0, s.GetCellValue("B2"));
            Assert.AreEqual(25.0, s.GetCellValue("C1"));
            Assert.AreEqual(25.0, s.GetCellValue("C2"));
